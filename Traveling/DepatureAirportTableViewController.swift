...
class DepatureAirportTableViewController: UITableViewController, UISearchResultsUpdating, DepartureAirportSearchTableViewDelegate  {
    ...
    func navigateToArrivalAirportTableViewController() {
        ...
        let storyBoard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil)
        let resultAirportTableController: ArrivalAirportTableViewController = storyBoard.instantiateViewControllerWithIdentifier("ArrivalAirportTableViewControllerId") as! ArrivalAirportTableViewController
